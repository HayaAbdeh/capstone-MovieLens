...
```{r initiate ratings, echo=TRUE , message=FALSE, warning=FALSE}
...
```{r first 100 predictions, echo=TRUE , message=FALSE, results='hide'}
...
```{r first 100 predictions nextpart, echo=TRUE , message=FALSE}
